...
genericUserInfoDecoder =
    Decode.message (GenericUserInfo "" False False False False Dict.empty Dict.empty Nothing)
...
userPredictionViewDecoder =
    Decode.message (UserPredictionView "" Nothing 0 0 0 0 0 "" "" Nothing [] 0 False)
