...
@docs Void, Pronouns, AuthKind, Auth, AuthErrorKind, AuthError, SignUpRequest, SignupResult, SignUpResponse, SignUpResponseError, CertaintyRange, PrivacyKind, MarketPrivacy, MarketPrivacyEmails, CreateMarketRequest, CreateMarketResult, CreateMarketResponse, CreateMarketResponseError, GetMarketRequest, GetMarketResult, GetMarketResponse, GetMarketResponseMarket, GetMarketResponseError, UserInfo, StakeRequest, StakeResult, StakeResponse, StakeResponseError, GetUserRequest, GetUserResult, GetUserResponse, GetUserResponseUser, GetUserResponseError, MarkTrustedRequest, Result, MarkTrustedResponse, MarkTrustedResponseError


# Decoder

@docs authDecoder, authErrorDecoder, signUpRequestDecoder, signUpResponseDecoder, certaintyRangeDecoder, marketPrivacyDecoder, createMarketRequestDecoder, createMarketResponseDecoder, getMarketRequestDecoder, getMarketResponseDecoder, userInfoDecoder, stakeRequestDecoder, stakeResponseDecoder, getUserRequestDecoder, getUserResponseDecoder, markTrustedRequestDecoder, markTrustedResponseDecoder


# Encoder

@docs toAuthEncoder, toAuthErrorEncoder, toSignUpRequestEncoder, toSignUpResponseEncoder, toCertaintyRangeEncoder, toMarketPrivacyEncoder, toCreateMarketRequestEncoder, toCreateMarketResponseEncoder, toGetMarketRequestEncoder, toGetMarketResponseEncoder, toUserInfoEncoder, toStakeRequestEncoder, toStakeResponseEncoder, toGetUserRequestEncoder, toGetUserResponseEncoder, toMarkTrustedRequestEncoder, toMarkTrustedResponseEncoder
...
type alias GetMarketResponseMarket =
    ...
    , certainty : Maybe CertaintyRange
    , maximumStake : Float
    , remainingYesStake : Float
    , remainingNoStake : Float
    , createdUnixtime : Int
    , closesUnixtime : Int
    , specialRules : String
...
certaintyRangeDecoder =
    Decode.message (CertaintyRange 0 0)
        [ Decode.optional 1 Decode.float setLowLogodds
        , Decode.optional 2 Decode.float setHighLogodds
        ]
...
createMarketRequestDecoder =
    Decode.message (CreateMarketRequest Nothing "" Nothing Nothing 0 0 "")
        ...
        , Decode.optional 5 Decode.float setMaximumStake
...
getMarketResponseMarketDecoder =
    Decode.message (GetMarketResponseMarket "" Nothing 0 0 0 0 0 "" Nothing)
        [ Decode.optional 1 Decode.string setQuestion
        , Decode.optional 2 (Decode.map Just certaintyRangeDecoder) setCertainty
        , Decode.optional 3 Decode.float setMaximumStake
        , Decode.optional 4 Decode.float setRemainingYesStake
        , Decode.optional 5 Decode.float setRemainingNoStake
...
stakeRequestDecoder =
    Decode.message (StakeRequest Nothing 0 False 0)
        ...
        , Decode.optional 4 Decode.float setStake
        ]
...
toCertaintyRangeEncoder model =
    Encode.message
        [ ( 1, Encode.float model.lowLogodds )
        , ( 2, Encode.float model.highLogodds )
        ]
...
toCreateMarketRequestEncoder model =
    Encode.message
        ...
        , ( 5, Encode.float model.maximumStake )
...
toGetMarketResponseMarketEncoder model =
    Encode.message
        ...
        , ( 3, Encode.float model.maximumStake )
        , ( 4, Encode.float model.remainingYesStake )
        , ( 5, Encode.float model.remainingNoStake )
...
setLowLogodds : a -> { b | lowLogodds : a } -> { b | lowLogodds : a }
setLowLogodds value model =
    { model | lowLogodds = value }


setHighLogodds : a -> { b | highLogodds : a } -> { b | highLogodds : a }
setHighLogodds value model =
    { model | highLogodds = value }
...
setRemainingYesStake : a -> { b | remainingYesStake : a } -> { b | remainingYesStake : a }
setRemainingYesStake value model =
    { model | remainingYesStake = value }


setRemainingNoStake : a -> { b | remainingNoStake : a } -> { b | remainingNoStake : a }
setRemainingNoStake value model =
    { model | remainingNoStake = value }
