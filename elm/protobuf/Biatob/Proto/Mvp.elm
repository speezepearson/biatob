...
type CreateInvitationResult
    = CreateInvitationResultOk InvitationId
...
createInvitationResponseDecoder =
    Decode.message (CreateInvitationResponse Nothing)
        [ Decode.oneOf
            [ ( 1, Decode.map CreateInvitationResultOk invitationIdDecoder )
