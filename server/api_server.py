...
class ApiServer:
    ...
    async def SetTradeDisavowal(self, http_req: web.Request) -> web.Response:
        return proto_response(self._servicer.SetTradeDisavowal(actor=self._token_glue.get_authorizing_user(http_req), request=await parse_proto(http_req, mvp_pb2.SetTradeDisavowalRequest)))
    ...
    def add_to_app(self, app: web.Application) -> None:
        ...
        app.router.add_post('/api/SetTradeDisavowal', self.SetTradeDisavowal)
