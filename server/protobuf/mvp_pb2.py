...
_WORLDSTATE_MARKET = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='resolutions', full_name='biatob.proto.mvp.WorldState.Market.resolutions', index=8,
