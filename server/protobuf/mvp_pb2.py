...
_WORLDSTATE_TRADE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='bettor_expected_resolution', full_name='biatob.proto.mvp.WorldState.Trade.bettor_expected_resolution', index=1,
