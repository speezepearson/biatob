...
_CREATEINVITATIONRESPONSE = _descriptor.Descriptor(
  ...
  nested_types=[_CREATEINVITATIONRESPONSE_ERROR, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
...
_CREATEINVITATIONRESPONSE.fields_by_name['ok'].message_type = _INVITATIONID
