...
_EMAILFLOWSTATE_CODESENT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='code_bcrypt', full_name='biatob.proto.mvp.EmailFlowState.CodeSent.code_bcrypt', index=1,
