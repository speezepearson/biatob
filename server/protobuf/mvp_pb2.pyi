...
class WorldState(google___protobuf___message___Message):
    ...
    class UsernameToUidEntry(google___protobuf___message___Message):
        DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
        ...
        if sys.version_info >= (3,):
            @classmethod
            def FromString(cls, s: builtin___bytes) -> WorldState.UsernameToUidEntry: ...
        else:
            @classmethod
            def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> WorldState.UsernameToUidEntry: ...
        def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"key",b"key",u"value",b"value"]) -> None: ...
    global___UsernameToUidEntry = UsernameToUidEntry
    ...
    @property
    def username_to_uid(self) -> typing___MutableMapping[typing___Text, builtin___int]: ...
    ...
    def __init__(self,
        *,
        ...
        username_to_uid : typing___Optional[typing___Mapping[typing___Text, builtin___int]] = None,
    ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"auth_token_owner_ids",b"auth_token_owner_ids",u"markets",b"markets",u"username_to_uid",b"username_to_uid",u"users",b"users"]) -> None: ...
