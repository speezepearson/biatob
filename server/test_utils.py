...
def SetTradeDisavowalOk(servicer: Servicer, actor: Optional[AuthorizingUsername], request: mvp_pb2.SetTradeDisavowalRequest) -> mvp_pb2.UserPredictionView:
  return assert_oneof(servicer.SetTradeDisavowal(actor, request), 'set_trade_disavowal_result', 'ok', mvp_pb2.UserPredictionView)
def SetTradeDisavowalErr(servicer: Servicer, actor: Optional[AuthorizingUsername], request: mvp_pb2.SetTradeDisavowalRequest) -> mvp_pb2.SetTradeDisavowalResponse.Error:
  return assert_oneof(servicer.SetTradeDisavowal(actor, request), 'set_trade_disavowal_result', 'error', mvp_pb2.SetTradeDisavowalResponse.Error)
